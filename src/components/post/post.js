  ...
  return (
   <main class="relative container mx-auto px-4">
    ...
    <article class="max-w-prose mx-auto py-8">
      ...
      <h2 class="mt-2 text-sm text-gray-500">Kevin Hernández, 28 November, 2021</h2>
  
      <p class="mt-6">Recently, I was in Developer Communities Whatsapp’s groups talking about new technologies, many of them were telling me about a new one created by the creator of Node.js…
        ...
        Git… maybe?
        (PD: Could be a MacOs Machine too)
        So…. Let’s start!
        .</p>
      </article>
  </main>
